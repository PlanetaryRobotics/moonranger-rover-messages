/*
 *  NASA Docket No. GSC-18,370-1, and identified as "Operating System
 * Abstraction Layer"
 *
...
** these extra attributes.  These test builds define the
*OSAPI_NO_SPECIAL_ATTRIBS
 ...
 * and libraries also define a boolean type due to the lack of a standard bool
 * in C89. But calling it simply "bool" or "boolean" almost guarantees a
 * namespace conflict if trying to use OSAL with one of those other existing
 * projects.
 *
 * RTEMS 4.11 no longer defines boolean type by default (deprecated) probably
 * also due to the high likelihood of name conflicts.
 *
 ...
 * The value for this had been set by the BSP makefiles but this is not
 * reliable, especially on processors that support both big- and little- endian
 * modes e.g. ARM and MIPS.
 *
...
#endif /* !defined(SOFTWARE_BIG_BIT_ORDER) && \
