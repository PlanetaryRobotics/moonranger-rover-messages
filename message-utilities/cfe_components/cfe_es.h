...
#define CFE_ES_TEST_LONG_MASK(m, s) \
    (CFE_ES_DTEST(                  \
        m[(s) / 32],                \
        (s) % 32)) /* Test a bit within an array of 32-bit integers. */
#define CFE_ES_MAX_MEMPOOL_BLOCK_SIZES \
    17 /**< Max number of size divisions allowed in a memory pool */
...
/** \{ */
#define CFE_ES_APP_RESTART                                               \
    CFE_PSP_RST_TYPE_MAX /**< Application only was reset (extend the PSP \
                            enumeration here) */
/** \} */
...
#define CFE_ES_CDS_MAX_FULL_NAME_LEN \
    (CFE_MISSION_ES_CDS_MAX_NAME_LENGTH + OS_MAX_API_NAME + 2)

#define CFE_ES_CDS_BAD_HANDLE (CFE_ES_CDSHandle_t)0xFFFF
/** \} */

#define CFE_ES_NO_MUTEX                                                   \
    0 /**< \brief Indicates that the memory pool selection will not use a \
         semaphore */
#define CFE_ES_USE_MUTEX                                              \
    1 /**< \brief Indicates that the memory pool selection will use a \
         semaphore */
...
//                                                  \brief Application ID for
//                                                  this Application */
//    uint32   Type;                           /**< \cfetlmmnemonic \ES_APPTYPE
//                                                  \brief The type of App: CORE
//                                                  or EXTERNAL */

//    char     Name[OS_MAX_API_NAME];          /**< \cfetlmmnemonic \ES_APPNAME
//                                                  \brief The Registered Name
//                                                  of the Application */
//    char     EntryPoint[OS_MAX_API_NAME];    /**< \cfetlmmnemonic
//    \ES_APPENTRYPT
//                                                  \brief The Entry Point label
//                                                  for the Application */
//    char     FileName[OS_MAX_PATH_LEN];      /**< \cfetlmmnemonic
//    \ES_APPFILENAME
//                                                  \brief The Filename of the
//                                                  file containing the
//                                                  Application */

//    uint32   StackSize;                      /**< \cfetlmmnemonic
//    \ES_STACKSIZE
//                                                  \brief The Stack Size of the
//                                                  Application */
//    uint32   ModuleId;                       /**< \cfetlmmnemonic \ES_MODULEID
//                                                  \brief The ID of the
//                                                  Loadable Module for the
//                                                  Application */
//    uint32   AddressesAreValid;              /**< \cfetlmmnemonic
//    \ES_ADDRVALID
//                                                  \brief Indicates that the
//                                                  Code, Data, and BSS
//                                                  addresses/sizes are valid */
//    uint32   CodeAddress;                    /**< \cfetlmmnemonic \ES_CODEADDR
//                                                  \brief The Address of the
//                                                  Application Code Segment*/
//    uint32   CodeSize;                       /**< \cfetlmmnemonic \ES_CODESIZE
//                                                  \brief The Code Size of the
//                                                  Application */
//    uint32   DataAddress;                    /**< \cfetlmmnemonic \ES_DATAADDR
//                                                  \brief The Address of the
//                                                  Application Data Segment*/
//    uint32   DataSize;                       /**< \cfetlmmnemonic \ES_DATASIZE
//                                                  \brief The Data Size of the
//                                                  Application */
//    uint32   BSSAddress;                     /**< \cfetlmmnemonic \ES_BSSADDR
//                                                  \brief The Address of the
//                                                  Application BSS Segment*/
//    uint32   BSSSize;                        /**< \cfetlmmnemonic \ES_BSSSIZE
//                                                   \brief The BSS Size of the
//                                                   Application */
//    uint32   StartAddress;                   /**< \cfetlmmnemonic
//    \ES_STARTADDR
//                                                  \brief The Start Address of
//                                                  the Application */
//    uint16   ExceptionAction;                /**< \cfetlmmnemonic
//    \ES_EXCEPTNACTN
//                                                  \brief What should occur if
//                                                  Application has an exception
//                                                  (Restart Application OR
//                                                  Restart Processor) */
//    uint16   Priority;                       /**< \cfetlmmnemonic \ES_PRIORITY
//                                                  \brief The Priority of the
//                                                  Application */
//    uint32   MainTaskId;                     /**< \cfetlmmnemonic
//    \ES_MAINTASKID
//                                                  \brief The Application's
//                                                  Main Task ID */
//    uint32   ExecutionCounter;               /**< \cfetlmmnemonic
//    \ES_MAINTASKEXECNT
//                                                  \brief The Application's
//                                                  Main Task Execution Counter
//                                                  */
//    char     MainTaskName[OS_MAX_API_NAME];  /**< \cfetlmmnemonic
//    \ES_MAINTASKNAME
//                                                  \brief The Application's
//                                                  Main Task ID */
//    uint32   NumOfChildTasks;                /**< \cfetlmmnemonic
//    \ES_CHILDTASKS
...
typedef struct {
    ...
    uint32
        NumCreated; /**< \brief Number of Memory Blocks of this size created */
    uint32 NumFree; /**< \brief Number of Memory Blocks of this size that are
                       free */
} CFE_ES_BlockStats_t;
...
typedef struct {
    ...
    uint32 NumBlocksRequested; /**< \cfetlmmnemonic \ES_BLKSREQ
                                    \brief Number of times a memory block has
                                  been allocated */
    uint32 CheckErrCtr;        /**< \cfetlmmnemonic \ES_BLKERRCTR
                                    \brief Number of errors detected when freeing a
                                  memory block */
    uint32
        NumFreeBytes; /**< \cfetlmmnemonic \ES_FREEBYTES
                           \brief Number of bytes never allocated to a block */
    CFE_ES_BlockStats_t
        BlockStats[CFE_ES_MAX_MEMPOOL_BLOCK_SIZES]; /**< \cfetlmmnemonic
                                                       \ES_BLKSTATS \brief
                                                       Contains stats on each
                                                       block size */
 ...
 *
 * Data type used to hold Handles of Critical Data Stores. See
 * #CFE_ES_RegisterCDS
 */
...
//     uint32                Size;            /**< \brief Size, in bytes, of the
//     CDS memory block */ bool                  Table;           /**< \brief
//     Flag that indicates whether CDS contains a Critical Table */ char
//     Name[CFE_ES_CDS_MAX_FULL_NAME_LEN]; /**< \brief Processor Unique Name of
//     CDS */ uint8                 ByteAlignSpare1; /**< \brief Spare byte to
//     insure structure size is multiple of 4 bytes */
// } CFE_ES_CDSRegDumpRec_t;

/*
** Child Task Main Function Prototype
*/
typedef void (*CFE_ES_ChildTaskMainFuncPtr_t)(
    void); /**< \brief Required Prototype of Child Task Main Functions */
typedef int32 (*CFE_ES_LibraryEntryFuncPtr_t)(
    uint32 LibId); /**< \brief Required Prototype of Library Initialization
                      Functions */

/**
 * \brief Pool Alignement
 *
 * Union that can be used for minimum memory alignment of ES memory pools on the
 * target. It contains the longest native data types such that the alignment of
 * this structure should reflect the largest possible alignment requirements for
 * any data on this processor.
 */
typedef union {
...
**          None
**
** \param[in]  StartType     Identifies whether this was a
*#CFE_PSP_RST_TYPE_POWERON or #CFE_PSP_RST_TYPE_PROCESSOR.
**
** \param[in]  StartSubtype  Specifies, in more detail, what caused the \c
*StartType identified above.
**                           See #CFE_PSP_RST_SUBTYPE_POWER_CYCLE for possible
*examples.
**
** \param[in]  ModeId        Identifies the source of the Boot as determined by
*the BSP.
**
** \param[in]  StartFilePath Identifies the startup file to use to initialize
*the cFE apps.
**
** \sa #CFE_ES_ResetCFE
**
******************************************************************************/
void CFE_ES_Main(uint32 StartType, uint32 StartSubtype, uint32 ModeId,
...
**
** \par Description
**        This API causes an immediate reset of the cFE Kernel and all cFE
*Applications.
**        The caller can specify whether the reset should clear all memory
...
**          None
**
** \param[in]  ResetType    Identifies the type of reset desired.  Allowable
*settings are:
**                          \arg #CFE_PSP_RST_TYPE_POWERON     - Causes all
*memory to be cleared
**                          \arg #CFE_PSP_RST_TYPE_PROCESSOR   - Attempts to
*retain volatile disk, critical data store and user reserved memory.
**
...
**
** \par Assumptions, External Events, and Notes:
**        The specified application will be deleted before it is reloaded from
*the
**        specified file.  In the event that an application cannot be reloaded
*due to
**        a corrupt file, the application may no longer be reloaded when given a
*valid
**        load file (it has been deleted and no longer exists).  To recover, the
**        application may be restarted by loading the application via the
*ES_STARTAPP
...
**          None
**
** \param[in]  ExitStatus Acceptable values are: \arg #CFE_ES_RunStatus_APP_EXIT
- \copybrief CFE_ES_RunStatus_APP_EXIT \arg #CFE_ES_RunStatus_APP_ERROR -
\copybrief CFE_ES_RunStatus_APP_ERROR \arg #CFE_ES_RunStatus_CORE_APP_INIT_ERROR
- \copybrief CFE_ES_RunStatus_CORE_APP_INIT_ERROR \arg
#CFE_ES_RunStatus_CORE_APP_RUNTIME_ERROR - \copybrief
...
**                          \arg #CFE_ES_RunStatus_APP_EXIT - \copybrief
*CFE_ES_RunStatus_APP_EXIT
**                          \arg #CFE_ES_RunStatus_APP_ERROR - \copybrief
...
**
** \par Assumptions, External Events, and Notes:
**        This API assumes that the caller has also been initialized
*sufficiently
...
**                                   This parameter must be at least 1000. Lower
*values
**                                   will be rounded up. There is not an option
*to
**                                   wait indefinitely to avoid hanging a
*critical
**                                   application because a non-critical app did
*not start.
**
...
**
******************************************************************************/
int32 CFE_ES_WaitForSystemState(uint32 MinSystemState,
...
**        useful for applications such as Health and Safety or the Scheduler
*that need
**        to wait until applications exist and are running before sending out
**        packets to them.
**
**        This is a specialized wrapper for CFE_ES_WaitForSystemState for
*compatibility
**        with applications using this API.
**
** \par Assumptions, External Events, and Notes:
**          This API should only be called as the last item of an Apps
*initialization.
**          In addition, this API should only be called by an App that is
*started
**          from the ES Startup file. It should not be used by an App that is
**          started after the system is running. ( Although it will cause no
*harm )
**
** \param[in]  TimeOutMilliseconds   The timeout value in Milliseconds.
**                                   This parameter must be at least 1000. Lower
...
**
** \par Assumptions, External Events, and Notes:
**        NOTE: This function \b MUST be called before any other cFE API
...
**        the calling task. It can be called from cFE Application main tasks,
*child
**        tasks, or cFE Core application main tasks. Normally, the call is not
**        necessary from a cFE Application, since the CFE_ES_RunLoop call
*increments
**        the counter for the Application.
**
** \par Assumptions, External Events, and Notes:
**        NOTE: This API is not needed for Appplications that call the
*CFE_ES_RunLoop call.
**
** \sa #CFE_ES_RunLoop
**
...
**          None
**
** \param[in, out]   ResetSubtypePtr    Pointer to \c uint32 type variable in
*which the Reset Sub-Type will be stored.
**                                 The caller can set this pointer to NULL if
*the Sub-Type is of no interest. \n *ResetSubtypePtr If the provided pointer was
*not \c NULL, the Reset Sub-Type is stored at the given address.
**                                 For a list of possible Sub-Type values, see
*\link #CFE_PSP_RST_SUBTYPE_POWER_CYCLE "Reset Sub-Types" \endlink.
**
**
...
**
** \par Description
**        This routine retrieves the cFE Application ID for the calling
*Application.
**
** \par Assumptions, External Events, and Notes:
**        NOTE: \b All tasks associated with the Application would return the
*same Application ID.
**
** \param[in]   AppIdPtr       Pointer to variable that is to receive the
*Application's ID. *AppIdPtr is the application ID of the calling Application.
**
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS       \copybrief CFE_SUCCESS
...
**
** \sa #CFE_ES_GetResetType, #CFE_ES_GetAppIDByName, #CFE_ES_GetAppName,
*#CFE_ES_GetTaskInfo
**
******************************************************************************/
...
*Application's ID. *AppIdPtr is the application ID of the calling Application.
**
** \param[in]   AppName        Pointer to null terminated character string
...
**
** \par Assumptions, External Events, and Notes:
**        In the case of a failure (#CFE_ES_ERR_APPID), an empty string is
*returned.  #CFE_ES_ERR_APPID
**        will be returned if the specified Application ID (AppId) is invalid or
*not in use.
**
** \param[in, out]   AppName       Pointer to a character array of at least \c
*BufferLength in size that will
**                            be filled with the appropriate Application name.
**AppName is the null terminated Application name of the Application associated
*with the
**                            specified Application ID
**
** \param[in]   AppId         Application ID of Application whose name is being
*requested.
**
** \param[in]   BufferLength  The maximum number of characters, including the
*null terminator, that can be put
**                            into the \c AppName buffer.  This routine will
*truncate the name to this length,
**                            if necessary.
**
**
** \return Execution status, see \ref CFEReturnCodes
...
** \retval #CFE_ES_ERR_APPID    \copybrief CFE_ES_ERR_APPID
**
** \sa #CFE_ES_GetResetType, #CFE_ES_GetAppID, #CFE_ES_GetAppIDByName,
*#CFE_ES_GetTaskInfo
**
******************************************************************************/
...
**        None
**
** \param[in, out]   AppInfo      Pointer to a \c CFE_ES_AppInfo_t structure
*that holds the specific
**                            Application information. *AppInfo is the filled
*out \c CFE_ES_AppInfo_t structure containing the
**                            App Name, and application memory addresses among
*other fields.
**
** \param[in]   AppId        Application ID of Application whose name is being
*requested.
...
**        specified Task ID. The information includes Task Name, and
*Parent/Creator
**        Application ID.
**
** \par Assumptions, External Events, and Notes:
**        None
**
** \param[in, out]   TaskInfo      Pointer to a \c CFE_ES_TaskInfo_t structure
*that holds the specific
**                            task information. *TaskInfo is the filled out \c
*CFE_ES_TaskInfo_t structure containing the
**                            Task Name, Parent App Name, Parent App ID among
*other fields.
**
** \param[in]   TaskId        Application ID of Application whose name is being
*requested.
**
**
** \return Execution status, see \ref CFEReturnCodes
...
**
** \par Description
**        This routine registers a cFE Child task and associates it with its
*parent
**        cFE Application.
**
** \par Assumptions, External Events, and Notes:
**        NOTE: This API \b MUST be called by the Child Task before any other
*cFE API calls are made.
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS                    \copybrief CFE_SUCCESS
** \retval #CFE_ES_ERR_CHILD_TASK_REGISTER \copybrief
...
**
** \par Description
**        This routine creates a new task (a separate execution thread) owned by
*the calling Application.
**
** \par Assumptions, External Events, and Notes:
**        None
**
** \param[in, out]   TaskIdPtr     A pointer to a variable that will be filled
*in with the new task's ID. *TaskIdPtr is the Task ID of the newly created child
*task.
**
** \param[in]   TaskName      A pointer to a string containing the desired name
*of the new task.
**                            This can be up to #OS_MAX_API_NAME characters,
*including the trailing null.
**
** \param[in]   FunctionPtr   A pointer to the function that will be spawned as
*a new task.  This function
**                            must have the following signature: uint32
*function(void).  Input parameters
**                            for the new task are not supported.
**
** \param[in]   StackPtr      A pointer to the location where the child task's
*stack pointer should start.
**                            NOTE: Not all underlying operating systems support
*this parameter.
**
** \param[in]   StackSize     The number of bytes to allocate for the new task's
*stack.
**
** \param[in]   Priority      The priority for the new task.  Lower numbers are
*higher priority, with 0 being
**                            the highest priority.  Applications cannot create
...
int32 CFE_ES_CreateChildTask(uint32 *TaskIdPtr, const char *TaskName,
                             ...
                             uint32 *StackPtr, uint32 StackSize,
...
**
** \par Description
**        This routine deletes a task under an Application specified by the \c
*TaskId obtained
...
**        None
**
** \param[in]   TaskId     The task ID previously obtained when the Child Task
*was created with the #CFE_ES_CreateChildTask API.
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS            \copybrief CFE_SUCCESS
** \retval #CFE_ES_NOT_IMPLEMENTED \copybrief CFE_ES_NOT_IMPLEMENTED
...
**
** \sa #CFE_ES_RegisterChildTask, #CFE_ES_CreateChildTask,
...
**                                This is similar to the format string for a
*printf() call.
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS             \copybrief CFE_SUCCESS
...
**
** \par Description
**        This routine calculates a cyclic redundancy check (CRC) on a block of
*memory.  The CRC algorithm
...
*This parameter
**                          allows the user to calculate the CRC of
*non-contiguous blocks as
**                          a single value.  Nominally, the user should set this
*value to zero.
**
** \param[in]   TypeCRC     One of the following CRC algorithm selections:
**                          \arg \c CFE_MISSION_ES_CRC_8 - (Not currently
*implemented)
**                          \arg \c CFE_MISSION_ES_CRC_16 - a CRC-16 algorithm
**                          \arg \c CFE_MISSION_ES_CRC_32 - (not currently
*implemented)
**
** \return The result of the CRC calculation on the specified memory block, or
*error code \ref CFEReturnCodes
**
******************************************************************************/
...
** \brief Notification that an asynchronous event was detected by the underlying
*OS/PSP
**
** \par Description
...
/*****************************************************************************/
/**
** \brief Reserve space (or re-obtain previously reserved space) in the Critical
*Data Store (CDS)
**
** \par Description
**        This routine allocates a block of memory in the Critical Data Store
*and associates it with
**        the calling Application.  The memory can survive an Application
*restart as well as a Processor Reset.
**
** \par Assumptions, External Events, and Notes:
**        None
**
** \param[in, out]   HandlePtr   Pointer Application's variable that will
*contain the CDS Memory Block Handle. *HandlePtr is the handle of the CDS block
*that can be used in
**                          #CFE_ES_CopyToCDS and #CFE_ES_RestoreFromCDS.
**
** \param[in]   BlockSize   The number of bytes needed in the CDS.
**
** \param[in]   Name        A pointer to a character string containing an
*application
**                          unique name of #CFE_MISSION_ES_CDS_MAX_NAME_LENGTH
*characters or less.
**
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS               The memory block was successfully created
*in the CDS.
** \retval #CFE_ES_NOT_IMPLEMENTED    The processor does not support a Critical
*Data Store.
...
**
******************************************************************************/
int32 CFE_ES_RegisterCDS(CFE_ES_CDSHandle_t *HandlePtr, int32 BlockSize,
                         const char *Name);
...
**
** \par Description
**        This routine copies a specified block of memory into the Critical Data
*Store that
**        had been previously registered via #CFE_ES_RegisterCDS.  The block of
*memory to be
**        copied must be at least as big as the size specified when registering
*the CDS.
**
** \par Assumptions, External Events, and Notes:
**        None
**
** \param[in]   Handle       The handle of the CDS block that was previously
*obtained from #CFE_ES_RegisterCDS.
**
** \param[in]   DataToCopy   A Pointer to the block of memory to be copied into
*the CDS.
**
** \return Execution status, see \ref CFEReturnCodes
...
**
** \par Description
**        This routine copies data from the Critical Data Store identified with
*the \c Handle into
**        the area of memory pointed to by the \c RestoreToMemory pointer.  The
*area of memory to
**        be copied into must be at least as big as the size specified when
*registering the CDS.
**        The recovery will indicate an error if the data integrity check
*maintained by the CDS
**        indicates the contents of the CDS have changed.  However, the contents
*will still be
...
**        None
**
** \param[in]   Handle             The handle of the CDS block that was
*previously obtained from #CFE_ES_RegisterCDS.
**
** \param[in, out]   RestoreToMemory    A Pointer to the block of memory that is
*to be restored with the contents of the CDS. *RestoreToMemory is the contents
...
/*****************************************************************************/
/**
** \brief Initializes a memory pool created by an application without using a
*semaphore during processing.
**
** \par Description
**        This routine initializes a pool of memory supplied by the calling
*application.  When a memory pool
...
**        -# 168 bytes are used for internal bookkeeping, therefore, they will
*not be available for allocation.
**
** \param[in, out]   HandlePtr   A pointer to the variable the caller wishes to
*have the memory pool handle kept in. *HandlePtr is the memory pool handle.
**
** \param[in]   MemPtr      A Pointer to the pool of memory created by the
*calling application. This address must
**                          be on a 32-bit boundary.
**
** \param[in]   Size        The size of the pool of memory.  Note that this must
*be an integral number of 32 bit words.
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS           \copybrief CFE_SUCCESS
** \retval #CFE_ES_BAD_ARGUMENT   \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateEx, #CFE_ES_GetPoolBuf,
*#CFE_ES_PutPoolBuf, #CFE_ES_GetMemPoolStats
**
******************************************************************************/
int32 CFE_ES_PoolCreateNoSem(CFE_ES_MemHandle_t *HandlePtr, uint8 *MemPtr,
                             uint32 Size);

/*****************************************************************************/
/**
** \brief Initializes a memory pool created by an application while using a
*semaphore during processing.
**
** \par Description
**        This routine initializes a pool of memory supplied by the calling
*application.  When a memory pool
**        created by this routine is processed, mutex handling will be
*performed.
**
** \par Assumptions, External Events, and Notes:
**        -# The size of the pool must be an integral number of 32-bit words
...
** \retval #CFE_ES_BAD_ARGUMENT   \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_PoolCreateNoSem, #CFE_ES_PoolCreateEx, #CFE_ES_GetPoolBuf,
*#CFE_ES_PutPoolBuf, #CFE_ES_GetMemPoolStats
**
******************************************************************************/
int32 CFE_ES_PoolCreate(CFE_ES_MemHandle_t *HandlePtr, uint8 *MemPtr,
                        uint32 Size);

/*****************************************************************************/
/**
** \brief Initializes a memory pool created by an application with application
...
*not be available for allocation.
**
** \param[in, out]   HandlePtr      A pointer to the variable the caller wishes
*to have the memory pool handle kept in. *HandlePtr is the memory pool handle.
**
** \param[in]   MemPtr         A Pointer to the pool of memory created by the
*calling application. This address must
**                             be on a 32-bit boundary.
**
** \param[in]   Size           The size of the pool of memory.  Note that this
*must be an integral number of 32 bit words.
**
** \param[in]   NumBlockSizes  The number of different block sizes specified in
*the \c BlockSizes array. If set equal to
**                             zero or if greater than 17, then default block
*sizes are used.
**
** \param[in]   BlockSizes     Pointer to an array of sizes to be used instead
*of the default block sizes specified by
**                             #CFE_PLATFORM_ES_MEM_BLOCK_SIZE_01 through
*#CFE_PLATFORM_ES_MAX_BLOCK_SIZE.  If the pointer is equal to NULL,
**                             the default block sizes are used.
**
** \param[in]   UseMutex       Flag indicating whether the new memory pool will
*be processing with mutex handling or not.
**                             Valid parameter values are #CFE_ES_USE_MUTEX and
*#CFE_ES_NO_MUTEX
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS           \copybrief CFE_SUCCESS
** \retval #CFE_ES_BAD_ARGUMENT   \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateNoSem, #CFE_ES_GetPoolBuf,
*#CFE_ES_PutPoolBuf, #CFE_ES_GetMemPoolStats
**
******************************************************************************/
int32 CFE_ES_PoolCreateEx(CFE_ES_MemHandle_t *HandlePtr, uint8 *MemPtr,
                          uint32 Size, uint32 NumBlockSizes, uint32 *BlockSizes,
                          uint16 UseMutex);

/*****************************************************************************/
/**
** \brief Gets a buffer from the memory pool created by #CFE_ES_PoolCreate or
*#CFE_ES_PoolCreateNoSem
**
** \par Description
**        This routine obtains a block of memory from the memory pool supplied
*by the calling application.
**
** \par Assumptions, External Events, and Notes:
**        -# The size allocated from the memory pool is, at a minimum, 12 bytes
*more than requested.
**
** \param[in, out]   BufPtr      A pointer to the Application's pointer in which
*will be stored the address of the allocated memory buffer. *BufPtr is the
*address of the requested buffer.
**
** \param[in]   HandlePtr   The handle to the memory pool as returned by
*#CFE_ES_PoolCreate or #CFE_ES_PoolCreateNoSem.
**
** \param[in]   Size        The size of the buffer requested.  NOTE: The size
...
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateNoSem, #CFE_ES_PoolCreateEx,
*#CFE_ES_PutPoolBuf, #CFE_ES_GetMemPoolStats, #CFE_ES_GetPoolBufInfo
**
******************************************************************************/
...
*#CFE_ES_PoolCreate or #CFE_ES_PoolCreateNoSem.
**
** \param[in]   BufPtr      A pointer to the memory buffer to provide status
*for.
**
** \return Execution status, see \ref CFEReturnCodes
** \retval #CFE_SUCCESS                \copybrief CFE_SUCCESS
...
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateNoSem, #CFE_ES_PoolCreateEx,
*#CFE_ES_GetPoolBuf, #CFE_ES_GetMemPoolStats, #CFE_ES_PutPoolBuf
**
******************************************************************************/
...
/*****************************************************************************/
/**
** \brief Releases a buffer from the memory pool that was previously allocated
*via #CFE_ES_GetPoolBuf
**
** \par Description
...
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateNoSem, #CFE_ES_PoolCreateEx,
*#CFE_ES_GetPoolBuf, #CFE_ES_GetMemPoolStats, #CFE_ES_GetPoolBufInfo
**
******************************************************************************/
...
**
** \par Description
**        This routine fills the #CFE_ES_MemPoolStats_t data structure with the
*statistics
**        maintained by the memory pool software.  These statistics can then be
*telemetered
**        by the calling Application.
**
** \par Assumptions, External Events, and Notes:
**        None
**
** \param[in, out]   BufPtr      Pointer to #CFE_ES_MemPoolStats_t data
*structure to be
**                          filled with memory statistics. *BufPtr is the Memory
*Pool Statistics stored in given data structure.
**
** \param[in]   Handle      The handle to the memory pool whose statistics are
*desired.
**
**
** \return Execution status, see \ref CFEReturnCodes
...
**
** \sa #CFE_ES_PoolCreate, #CFE_ES_PoolCreateNoSem, #CFE_ES_PoolCreateEx,
*#CFE_ES_GetPoolBuf, #CFE_ES_PutPoolBuf
**
******************************************************************************/
...
** \retval #CFE_ES_BAD_ARGUMENT \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_IncrementGenCounter, #CFE_ES_DeleteGenCounter,
*#CFE_ES_SetGenCount, #CFE_ES_GetGenCount, #CFE_ES_GetGenCounterIDByName
**
******************************************************************************/
...
** \retval #CFE_ES_BAD_ARGUMENT  \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_IncrementGenCounter, #CFE_ES_RegisterGenCounter,
*#CFE_ES_SetGenCount, #CFE_ES_GetGenCount, #CFE_ES_GetGenCounterIDByName
**
******************************************************************************/
...
** \retval #CFE_ES_BAD_ARGUMENT \copybrief CFE_ES_BAD_ARGUMENT
**
** \sa #CFE_ES_RegisterGenCounter, #CFE_ES_DeleteGenCounter,
*#CFE_ES_SetGenCount, #CFE_ES_GetGenCount, #CFE_ES_GetGenCounterIDByName
**
******************************************************************************/
...
**
** \par Description
**        This routine sets the specified generic counter to the specified
*value.
**
** \par Assumptions, External Events, and Notes:
**        None.
...
**
** \sa #CFE_ES_RegisterGenCounter, #CFE_ES_DeleteGenCounter,
*#CFE_ES_IncrementGenCounter, #CFE_ES_GetGenCount, #CFE_ES_GetGenCounterIDByName
**
******************************************************************************/
...
**
** \sa #CFE_ES_RegisterGenCounter, #CFE_ES_DeleteGenCounter,
*#CFE_ES_SetGenCount, #CFE_ES_IncrementGenCounter, #CFE_ES_GetGenCounterIDByName
**
******************************************************************************/
...
**
** \par Description
**        This routine gets the Counter Id for a generic counter specified by
*name.
**
** \par Assumptions, External Events, and Notes:
**        None.
...
**
** \sa #CFE_ES_RegisterGenCounter, #CFE_ES_DeleteGenCounter,
*#CFE_ES_SetGenCount, #CFE_ES_IncrementGenCounter, #CFE_ES_GetGenCount
******************************************************************************/
int32 CFE_ES_GetGenCounterIDByName(uint32 *CounterIdPtr,
