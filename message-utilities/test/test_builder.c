...
Message Len: MOONRANGER_WHEEL_VEL_CMD_MSG_LNGTH (this is a constant that is
declared) Message ID: 0x0D09 Message Data: Duration - 10 leftFront - 8.0
    rightFront - 4.0
    leftBack - 6.0
    rightBack - 2.0
...
void test_message_builder_build(void) {
    ...
    // messageBuildTlm(&test_message, &msg_container, sizeof(test_message),
    // 0x0D05);
