...
#define TLM_OUTPUT_REMOVE_PACKET_PAYLOAD_LEN \
    sizeof(TLM_OUTPUT_RemovePacket_Payload_t)
...
#define TLM_OUTPUT_ENABLE_OUTPUT_PAYLOAD_LEN \
    sizeof(TLM_OUTPUT_EnableOutput_Payload_t)
